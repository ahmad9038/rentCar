...
import EditCloudinary from "../components/EditCloudinary";
...
const EditCar = () => {
  ...
  useEffect(() => {
    if (carData) {
      ...
      setAC(carData.ac);
      setAutomatic(carData.automatic);
      setSeatCapacity(carData.seatCapacity || "");
          ...
          <div className=" min-h-screen flex flex-col items-center justify-center py-6 px-2 sm:px-4">
            <div className="  z-10 border border-stroke-1 bg-n-7 w-full   rounded-md p-3 sm:p-6 max-w-2xl  max-md:mx-auto">
              ...
              Your journey begins here.
                ...
                <div className="!mt-5">
                  <p className="text-center mb-1 text-red-400">
                    {errorMessage}
                  </p>
                  <button
                    disabled={loading}
